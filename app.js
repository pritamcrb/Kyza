     ...
     if (who == "local"){
         ...
         control = '<li style="width:100%;">' +
                        '<div class="msj-rta macro">' +
                            ...
                            '</div>' +
                        '<div class="avatar" style="padding:0px 0px 0px 0px !important;float: right !important;width: 75px;margin: 3px 0px 0px 134px;"><img class="img-circle" style="width:100%;" src="'+local.avatar+'" /></div>' +                                
                  '</li>';                   
    }else{
        control = '<li style="width:100%">' +
                        '<div class="msj macro">' +
